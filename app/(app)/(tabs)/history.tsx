      ...
      {tabs.map(tab => {
        ...
        return (
          <Pressable key={tab.key} onPress={() => { haptic(); onChange(tab.key); }} style={{ flex: 1, paddingVertical: 9, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', gap: 5, zIndex: 1 }}>
            ...
            {tab.count > 0 && (
              <View style={{ backgroundColor: isActive ? 'rgba(255,255,255,0.25)' : 'rgba(255,255,255,0.06)', borderRadius: RADIUS.full, paddingHorizontal: 5, minWidth: 16, alignItems: 'center' }}>
      ...
      >
        <View style={{
          ...
          >
            ...
            {/* meta strip: icon · depth · date  ……  actions */}
            ...
            {/* Title — full-width hero line; long titles wrap cleanly */}
            ...
            <LinearGradient colors={['#15152F', '#0D0D22']} style={{ paddingBottom: SPACING.sm }}>
              ...
              {!compareMode && reports.length > 0 && (
                <View style={{ flexDirection: 'row', gap: SPACING.sm, paddingHorizontal: SPACING.xl, marginBottom: SPACING.sm }}>
                  ...
                  <StatCard icon="bookmark" value={String(bookmarkedCount)} label="Saved" gradient={[COLORS.secondary, '#FF8E53']} accent={COLORS.secondary} />
            ...
            {compareMode && (
              <Animated.View entering={FadeInDown.duration(300)} exiting={FadeOut.duration(150)} style={{ paddingHorizontal: SPACING.xl, paddingTop: SPACING.sm }}>
                <View style={{ borderRadius: RADIUS.lg, overflow: 'hidden', borderWidth: 1, borderColor: `${COLORS.primary}40` }}>
                  <LinearGradient colors={['#1E1E48', '#14142E']} style={{ padding: SPACING.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <View style={{ flex: 1 }}>
