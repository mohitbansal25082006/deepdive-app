      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <Animated.View entering={FadeIn.duration(400)} style={styles.header}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.headerMeta}>
              {report.depth?.toUpperCase()} · {new Date(report.createdAt).toLocaleDateString('en-US', {
          ...
          >
            <Ionicons
              name="chatbubbles-outline" size={18}
        ...
        {report.reliabilityScore > 0 && (
          <Animated.View entering={FadeIn.duration(400).delay(100)} style={styles.statsStrip}>
            ...
            <StatPill
              ...
              label="reliability"
              color={
                report.reliabilityScore >= 7 ? COLORS.success
                : report.reliabilityScore >= 5 ? COLORS.warning
                : COLORS.error
              }
            />
          </Animated.View>
        ...
        {isEditor && !showComments && (
          <Animated.View entering={FadeIn.duration(300)} style={[styles.fab, { bottom: insets.bottom + 20 }]}>
            <TouchableOpacity
              onPress={handleHeaderCommentPress}
              style={styles.fabBtn}
              activeOpacity={0.85}
            >
