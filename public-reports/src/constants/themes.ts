// ─────────────────────────────────────────────────────────────────────────────
// Part 55.9 — Public Reports Theme System (definitions)
// Ported from mobile app's themes.ts with web-compatible adaptations
// ─────────────────────────────────────────────────────────────────────────────
...
export interface ThemeDefinition {
  ...
  name: string;
  description: string;
  /** Icon name for display (using emoji fallback for web) */
  icon: string;
...
// ═════════════════════════════════════════════════════════════════════════════
// THEME 1 — Cosmic Indigo (original DeepDive look)
// ═════════════════════════════════════════════════════════════════════════════
...
// ═════════════════════════════════════════════════════════════════════════════
// THEME 3 — Sunset Coral (DEFAULT for public reports)
// ═════════════════════════════════════════════════════════════════════════════
...
// ═════════════════════════════════════════════════════════════════════════════
// Registry — DEFAULT is Sunset Coral (Light)
// ═════════════════════════════════════════════════════════════════════════════
